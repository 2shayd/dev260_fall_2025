...
namespace Lab8_Sets
{
    ...
    public class SetOperationsLab
    {
        ...
        public int DeduplicateEmails(List<string> emailList)
        {
            ...
            //clear and repopulate the emailList with unique emails
            emailList.Clear();
            emailList.AddRange(uniqueEmailSet);

            //how many dupes were removed
            int dupesRemoved = orginalCount - emailList.Count;
            return dupesRemoved;
        }
        ...
        public int AddPermissions(string userId, HashSet<string> newPermissions)
        {
            ...
            //add new permissions -> merges sets and avoids duplicates
        ...
        public HashSet<string> GetMissingPermissions(string userId, HashSet<string> requiredPermissions)
        {
            ...
            if (!userPermissions.ContainsKey(userId))
            {
                return new HashSet<string>(requiredPermissions); //user not found, all permissions missing
            }
        ...
        public HashSet<string> FindNewStudents()
        {
            ...
            //find students in enrolledNow but not in enrolledLastQuarter
            newStudents.ExceptWith(enrolledLastQuarter);

            //return enrolledNow.Except(enrolledLastQuarter).ToHashSet(); <- one line version
        ...
        public HashSet<string> FindContinuingStudents()
        {
            ...
            //intersect to find students who were here before and now
        ...
        public double CalculateRetentionRate()
        {
            ...
            int lastQuarterCount = enrolledLastQuarter.Count;
